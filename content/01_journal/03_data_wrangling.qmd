...
patent_tbl <- vroom(
  file       = "C:\\Users\\Admin\\Documents\\GitHub\\ss23-bdsb-Gurukiran4\\patent_data\\patent.tsv", 
  delim      = "\t", 
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
uspc_tbl <- vroom(
  file       = "C:\\Users\\Admin\\Documents\\GitHub\\ss23-bdsb-Gurukiran4\\patent_data\\uspc.tsv", 
  delim      = "\t", 
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
patent_assignee_tbl <- vroom(
  file       = "C:\\Users\\Admin\\Documents\\GitHub\\ss23-bdsb-Gurukiran4\\patent_data\\patent_assignee.tsv", 
  delim      = "\t", 
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
assignee_tbl <- vroom(
  file       = "C:\\Users\\Admin\\Documents\\GitHub\\ss23-bdsb-Gurukiran4\\patent_data\\assignee.tsv", 
  delim      = "\t", 
  col_types  = col_types,
  na         = c("", "NA", "NULL")
)
